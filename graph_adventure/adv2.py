...
def mark_visited(visited, rm_coord, traveled_dir=None):
    ...
    if rm_coord not in visited:
        for dir in rm_exits:
            ...
            # print("exits added:",room_exits)
        if traveled_dir != None:
            # print("room traveld dir:",traveled_dir)
...
def traverse_map():
    ...
    traveled_ids.append(rm_coord)
    mark_visited(visited, rm_coord)
    ...
    while len(new_rooms) > 0:
        ...
        if counter > 400:
            ...
            print("ROOM",get_rm_coord(),"\nDIR",dir,"\nDIRECTIONS",new_rooms,"\nTRAVELED",traveled)
        if dir in visited[rm_coord] and not visited[rm_coord][dir]:
            # print("===")
            # print("DIRECTION", dir)
        ...
        elif dir in visited[rm_coord] and visited[rm_coord][dir] and len(traveled) > 0:
            # print("+++")
            new_rooms.append(dir)
            dir = rev_dir[traveled.pop()]
            player.travel(dir, False)
            traveled_ids.append(get_rm_coord())
            traversalPath.append(dir)
        else:
        ...
        if counter % 10 == 0:
            print("room",get_rm_coord(),"visited rooms", len(visited),"counter",counter)
